...
dataset = pd.read_csv("../Input/Data_Solar_Load.csv")
...
with open('../Output/solarVfLoad.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    header = ["Solar Market Share", "Current_Load", "High_Load", "Low_Load"]
